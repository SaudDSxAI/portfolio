        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {stats.map((stat, index) => (
            <ScrollReveal key={stat.label} delay={index * 100}>
              <div className="group relative bg-warm-100/80 backdrop-blur-xl border border-black/10 rounded-2xl p-6 text-center hover:border-black/20 hover:shadow-xl hover:shadow-black/10 hover:-translate-y-1 transition-all duration-300">
