  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
        {/* Greeting */}
        <div className="inline-flex items-center gap-2 px-4 py-2 mb-8 bg-warm-100/80 backdrop-blur-sm border border-black/10 rounded-full text-sm text-zinc-700 animate-fade-in shadow-sm">
        ...
        >
          ...
          <button
            ...
            className="group px-8 py-4 bg-warm-100/80 backdrop-blur-sm hover:bg-warm-200 text-black font-bold rounded-2xl border border-black/15 hover:border-black/40 transition-all duration-300 hover:-translate-y-1 active:scale-95 flex items-center justify-center gap-2"
          >
