  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none z-0">
        <div className="absolute top-[-15%] left-[-10%] w-[50%] h-[50%] bg-primary-900/30 rounded-full blur-[130px] animate-blob" />
        <div className="absolute top-[30%] right-[-15%] w-[40%] h-[40%] bg-sky-900/20 rounded-full blur-[130px] animate-blob animation-delay-2000" />
        <div className="absolute bottom-[-15%] left-[25%] w-[55%] h-[55%] bg-cyan-900/20 rounded-full blur-[130px] animate-blob animation-delay-4000" />
      </div>
