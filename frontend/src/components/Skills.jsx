...
export default function Skills() {
 ...
 <div className="group relative bg-warm-100/85 border border-black/10 rounded-2xl p-6 hover:border-black/20 hover:shadow-xl hover:shadow-black/10 transition-all duration-500 h-full">
 {/* Removed hover glow */}
