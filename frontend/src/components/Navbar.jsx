    ...
    <>
      <nav
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
          scrolled
            ? 'bg-warm-50/75 backdrop-blur-2xl border-b border-black/10 shadow-[0_4px_24px_-8px_rgba(0,0,0,0.08)]'
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-warm-50/90 backdrop-blur-2xl border-t border-black/10 pb-safe shadow-[0_-4px_24px_-8px_rgba(0,0,0,0.1)]">
